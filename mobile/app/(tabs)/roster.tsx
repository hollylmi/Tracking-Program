...
const CELL_CFG: Record<string, { bg: string; text: string; abbrev: string }> = {
  ...
  office:    { bg: '#FDE8D8', text: '#6C3A00', abbrev: 'OFF' },
  office_sydney:    { bg: '#FDE8D8', text: '#6C3A00', abbrev: 'SYD' },
  office_melbourne: { bg: '#FDE8D8', text: '#6C3A00', abbrev: 'MEL' },
  terminated: { bg: '#E0E0E0', text: '#AAAAAA', abbrev: '' },
...
const PERSONAL_STATUS_CFG: Record<string, { bg: string; text: string; dot: string }> = {
  ...
  office:    { bg: 'rgba(255,152,0,0.15)',  text: '#FFB74D', dot: '#FF9800' },
  office_sydney:    { bg: 'rgba(255,152,0,0.15)',  text: '#FFB74D', dot: '#FF9800' },
  office_melbourne: { bg: 'rgba(255,152,0,0.15)',  text: '#FFB74D', dot: '#FF9800' },
  terminated: { bg: 'rgba(128,128,128,0.1)', text: '#888888', dot: '#666666' },
